...
class Player(BasePlayer):
    ...
    Intention2 = models.StringField(
        choices=likert_choices,
        label=' I have tried to purchase from an ethical clothing retailer over the last month from home')
    Plan1 = models.StringField(
        choices=likert_choices,
        label=' I made a plan to buy from an ethical clothing retailer from home in the last month')
    Intention4 = models.StringField(
        choices=likert_choices,
        label=' I wanted to purchase from an ethical clothing retailer from home in the last month')
    SubjectiveNorm2 = models.StringField(
        choices=likert_choices,
        label=' My family has purchased from an ethical clothing retailer in the last month from home')
    SubjectiveNorm3 = models.StringField(
        choices=likert_choices,
        label='Those that are important to me think I should purchase from an ethical clothing retailer when I’ve been at home in the last month')
    SubjectiveNorm4 = models.StringField(
        choices=likert_choices,
        label='I’ve felt pressure from society in the last month to purchase from an ethical clothing retailer when at home')
    SubjectiveNorm5 = models.StringField(
        choices=likert_choices,
        label=' My friends think I should purchase from an ethical clothing retailer')
    PBC1 = models.StringField(
        choices=likert_choices,
        label='It would’ve been easy for me to purchase from an ethical clothing retailer from home in the last month')
    PBC2 = models.StringField(
        choices=likert_choices,
        label='I’ve had complete control over being able to purchase from an ethical clothing retailer from home in the last month')
    PBC3 = models.StringField(
        choices=likert_choices,
        label='It would’ve been challenging to purchase from an ethical clothing retailer from home in the last month')
    PBC4 = models.StringField(
        choices=likert_choices,
        label='If I wanted to, I could’ve purchased from an ethical clothing retailer from home in the last month')
    PBC5 = models.StringField(
        choices=likert_choices,
        label='It has been up to me whether I’ve bought from an ethical clothing retailer from home in the last month')
    Age = models.IntegerField(blank=True, label='What is your age?')
    Gender = models.StringField(blank=True, choices=[['1', 'Male'], ['2', 'Female'], ['3', 'Other']],
                                label='What is your gender? ')
    Ethnicity = models.StringField(blank=True, choices=[
        ...
        ['4', 'Black / Black British (African / Caribbean / Other)']], label='What is your ethnicity? ')
    ...
    Attitude2 = models.StringField(
        choices=likert_choices,
        label='The impact on the environment caused by purchasing from ethical clothing retailers would be good')
    Attitude3 = models.StringField(
        choices=likert_choices,
        label='The impact on employee welfare caused by purchasing from ethical clothing retailers would be good')
    Attitude4 = models.StringField(
        choices=likert_choices,
        label='The impact on animal welfare caused by purchasing from ethical clothing retailers would be good')
    ...
    Attitude22 = models.StringField(
        choices=likert_choices,
        label='The impact on the environment caused by purchasing from ethical clothing retailers would be effective')
    Attitude32 = models.StringField(
        choices=likert_choices,
        label='The impact on employee welfare caused by purchasing from ethical clothing retailers would be effective')
    Attitude42 = models.StringField(
        choices=likert_choices,
        label='The impact on animal welfare caused by purchasing from ethical clothing retailers would be effective')
    Plan2 = models.StringField(
        choices=likert_choices,
        label='I have taken steps to purchase from ethical clothes retailers from home in the last month')
